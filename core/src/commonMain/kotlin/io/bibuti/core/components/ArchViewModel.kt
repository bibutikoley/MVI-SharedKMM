...
import io.bibuti.core.coroutines.EventsConfiguration
import io.bibuti.core.interfaces.*
...
abstract class ArchViewModel<Action : Any, State : Any, SideEffect : SideEffectInterface, Event : Any, RenderState : Any> constructor(
